...
contract SetRiskParams is Script {
    ...
    function run() external {
        ...
        (uint256 imr1, uint256 mmr1, uint256 penalty1, uint256 cap1) = clearingHouse.marketRiskParams(ETH_PERP_V2_MARKET_ID);
        ...
        (uint256 imr2, uint256 mmr2, uint256 penalty2, uint256 cap2) = clearingHouse.marketRiskParams(ETH_PERP_MARKET_ID);
