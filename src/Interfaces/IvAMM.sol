...
interface IVAMM {
    ...
    /// @notice Buy base (long) by paying quote notionally; returns executed deltas and average price.
    /// @param baseAmount Target base quantity to acquire (1e18-scaled base units).
    /// @param priceLimitX18 Slippage protection: max acceptable price (1e18) for baseForQuote.
    ...
    /// @notice Sell base exposure (short) by paying quote; returns executed deltas and average price.
    /// @param quoteAmount Quote notional spent (1e18-scaled quote units).
    /// @param priceLimitX18 Slippage protection: min acceptable price (1e18) for quoteForBase.
    /// @return baseDelta Signed base change (negative when increasing short exposure).
    ...
    /// @notice Sell base (short/close long) by providing base notionally; returns executed deltas and average price.
