...
contract InsuranceFundTest is BaseTest {
    ...
    function test_OnFeeReceived() public {
        ...
        // Simulate fee router sending fees
        usdc.mint(address(insuranceFund), feeAmount);
    ...
    function test_OnFeeReceived_Multiple() public {
        ...
        usdc.mint(address(insuranceFund), fee1 + fee2 + fee3);
        ...
        assertEq(insuranceFund.totalReceived(), fee1 + fee2 + fee3, "Total received incorrect");
    }
    ...
    function test_CanHandleZeroBalance() public {
        ...
        usdc.mint(address(insuranceFund), newFee);
        vm.prank(address(feeRouter));
    ...
    function test_NetPosition() public {
        // Receive 10k in fees
        usdc.mint(address(insuranceFund), 10000 * USDC_UNIT);
        vm.prank(address(feeRouter));
